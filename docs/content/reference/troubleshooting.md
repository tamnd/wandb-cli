...
Most of these come down to network reality or how wandb serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

wandb rate-limits like any public site. wandb already paces
...
Where a surface is gated, wandb reads a cookie or token you supply
...
`wandb`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what wandb actually did
