...
// HTTP behaviour is covered in wandb_test.go.
...
func TestDomainInfo(t *testing.T) {
	...
	if info.Identity.Binary != "wandb" {
		t.Errorf("Identity.Binary = %q, want wandb", info.Identity.Binary)
	}
}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "wandb://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("wandb", "about")
	if err != nil || got.String() != "wandb://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want wandb://page/about", got.String(), err)
	}
}
